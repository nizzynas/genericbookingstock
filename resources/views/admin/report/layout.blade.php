...
@section('content')
    <ul class="nav nav-tabs mb-5" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="customers-tab" data-toggle="tab" href="#customers" role="tab" aria-controls="customers"
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="customers" role="tabpanel" aria-labelledby="customers-tab">@include('admin.report.customer-report')</div>
